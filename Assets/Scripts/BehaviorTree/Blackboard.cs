...
namespace SimpleBehaviorTreeEditor.Scripts.BehaviorTree
{
    ...
    public class Blackboard
    {
        ...
        public Dictionary<string, string> Conditions = new Dictionary<string, string>(); //Necessary, used for nodes which are scripted to check if condition is set before starting. Not sure if this is necessary for anything...
        ...
        private Dictionary<int, Vector3> Vectors = new Dictionary<int, Vector3>();
        ...
        {
            if (Vectors.ContainsKey(Keys[key]))
            {
                Vectors[Keys[key]] = value;
                return;
            }
            Vectors.Add(Keys[key], value);
        }
        ...
        {
            return Vectors[Keys[key]];
        }

        public bool VectorExist(string key)
        {
            return Vectors.ContainsKey(Keys[key]);
        }
